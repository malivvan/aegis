...
func (e ErrInvalidSignature) Error() string {
	return fmt.Sprintf(
		"kdbx: invalid signature. %s is %x. Should be %x",
		e.Name,
		e.Is,
		e.Shouldbe,
	)
...
var ErrEndOfHeaders = errors.New("kdbx: header id was 0, end of headers")
...
func (i ErrUnknownHeaderID) Error() string {
	return fmt.Sprintf("kdbx: unknown header ID of %d", i)
}
...
func (s ErrUnknownParameterID) Error() string {
	return fmt.Sprintf("kdbx: unknown kdf parameter '%s'", string(s))
}
